...
public class CalendarProgramView implements CalendarView{
    ...
    private JCheckBox secondFilter;
    private JCheckBox firstFilter;
	...
	public CalendarProgramView()
		...
		gl_interactPanel.setHorizontalGroup(
			gl_interactPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_interactPanel.createSequentialGroup()
					...
					.addGap(81)
					.addGroup(gl_interactPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, gl_interactPanel.createSequentialGroup()
        ...
        calendarTable.getParent().setBackground(calendarTable.getBackground()); //Set background
                ...
                calendarTable.getTableHeader().setReorderingAllowed(false);
                        ...
                        calendarTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
                                ...
                                JButton btnCreate = new JButton("BUTTON");
		...
		secondFilter = new JCheckBox("Filter1");
		secondFilter.setSelected(true);

		secondFilter.setIconTextGap(10);
		
		firstFilter = new JCheckBox("Filter2");
		firstFilter.setSelected(true);

		firstFilter.setIconTextGap(10);
				...
				.addGroup(gl_filterPanel.createSequentialGroup()
					.addGroup(gl_filterPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_filterPanel.createSequentialGroup()
							.addGap(43)
							.addGroup(gl_filterPanel.createParallelGroup(Alignment.LEADING)
								.addComponent(firstFilter)
								.addComponent(secondFilter))))
